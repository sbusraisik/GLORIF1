...
gsim_df = pd.read_csv('/scratch-shared/bisik/Data/preprocess/preproces_gsim/GSIM_catchment_characteristics.csv')
#gsim_df = pd.read_csv('/home/bisik/Practical/gsim_preprocess/station_to_pixel_mapping_gsim.csv')
grdc_df = pd.read_csv('/scratch-shared/bisik/Data/preprocess/preproces_grdc/stationLatLon_grdc.csv')
...
filtered_gsim_df.to_csv('/scratch-shared/bisik/Data/preprocess/preproces_gsim/filtered_GSIM_catchment_characteristics.csv', index=False)
